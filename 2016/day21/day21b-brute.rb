...
# Create all possible mutations of input string.
mutations = string.chars.permutation.map(&:join)
...
mutations.each do |mutation|
  ...
  instructions.each do |instruction|
    mutation = manipulate(mutation, instruction)
  end
