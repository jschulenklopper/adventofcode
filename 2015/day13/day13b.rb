...
# Add myself to the list, and zero-valued preferences for all members.
me = family.push(Member.new("me")).last
family.each do |member|
  member.set_preference(me, 0)
  me.set_preference(member, 0)
end
